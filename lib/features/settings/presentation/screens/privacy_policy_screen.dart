        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              ...
              "O Life OS utiliza Firebase Authentication e Google Sign-In para autenticação, Cloud Firestore para armazenar e sincronizar dados compatíveis, Firebase App Check para ajudar a proteger o acesso às APIs e infraestrutura da Vercel para processar requisições do backend. Quando o Companion IA é utilizado com consentimento ativo, a solicitação é processada pelo Gemini, serviço de IA do Google. As métricas de uso do Firebase Analytics são opcionais e podem ser ativadas ou desativadas nas configurações de Segurança e Privacidade. Quando ativadas, servem para compreender o uso e melhorar o produto. O Life OS não pretende enviar como eventos do Analytics conteúdo de saúde, finanças, medicamentos, ciclo, mensagens de IA, e-mail ou outros conteúdos inseridos pelo usuário. Em versões de produção, o Firebase Crashlytics é tratado separadamente e pode receber relatórios técnicos de falhas para diagnóstico e estabilidade. O aplicativo sanitiza o conteúdo dos erros que registra, evitando o envio da mensagem bruta da exceção.",
            ),
            _buildSection(
